...
def _plan_record(record: dict[str, Any]) -> _MigrationPlan | None:
    ...
    direct_map = {
        ...
        "architecture": ("decision_trail", "decision"),
        "design_pattern": ("decision_trail", "decision"),
        "component_rel": ("decision_trail", "decision"),
        "tech_constraint": ("project_dna", "core_requirement"),
        "tech_stack": ("project_dna", "product_context"),
        "tech_setup": ("project_dna", "product_context"),
        "env_config": ("project_dna", "product_context"),
        "external_dep": ("project_dna", "product_context"),
    }
